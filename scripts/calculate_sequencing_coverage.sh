...
# Export the per sample txt file to R and plot the coverage plots using the following code
...
# Save the coverage dataframe for C001 sample  # Do this to all the 70 samples
